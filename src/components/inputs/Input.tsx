  ...
  return (
    <div className='w-full relative'>
      ...
      <input
        ...
        type={type}
        className={`
           ${formatPrice? 'pl-9 !important': 'pl-4 !important'}
      ...
      />
      <label className={`absolute text-neutral-500 text-md duration-150 transform -translate-y-3 top-5 z-10 origin-[0]
                        ${formatPrice? 'left-9 !important': 'left-4 !important'}
                        ${errors[id] ? 'text-rose-500': 'text-zing-400'}
